...
os.system('/Users/phoenixzhang/Downloads/yunos-sdk_v0.2.5_20161222.1220/tools/adb/adb -host push /Users/phoenixzhang/Downloads/plover/runtime/test/configunittest.json /test')
time.sleep(1)
f=open("/Users/phoenixzhang/Downloads/autotest.txt",'w')

os.system('/Users/phoenixzhang/Downloads/yunos-sdk_v0.2.5_20161222.1220/tools/adb/adb -host shell testrbc -f /test/configunittest.json -r >>~/Downloads/autotest.txt')
